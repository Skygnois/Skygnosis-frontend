...
;
const metadata = {
    title: "Braintech - AI & Tech Consulting",
    description: "Transform your business with cutting-edge AI and technology solutions. Expert consulting for innovation and digital transformation.",
    icons: {
        icon: [
            {
